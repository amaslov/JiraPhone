/*
	RemoteUser.h
	The implementation of properties and methods for the RemoteUser object.
...
@implementation RemoteUser
	...
	+ (RemoteUser*) newWithNode: (CXMLNode*) node
	{
		...
		return (RemoteUser*)[[[RemoteUser alloc] initWithNode: node] autorelease];
	}
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[RemoteUser class]]) {
