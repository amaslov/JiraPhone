/*
	RemoteProject.h
	The implementation of properties and methods for the RemoteProject object.
...
@implementation RemoteProject
	...
	- (id) init
	{
		if(self = [super init])
		{
			...
			self.issueSecurityScheme = nil; // [[RemoteScheme alloc] init];
			self.key = nil;
			self.lead = nil;
			self.notificationScheme = nil; // [[RemoteScheme alloc] init];
			self.permissionScheme = nil; // [[RemotePermissionScheme alloc] init];
			self.projectUrl = nil;
			self.url = nil;
	...
	+ (RemoteProject*) newWithNode: (CXMLNode*) node
	{
		...
		return (RemoteProject*)[[[RemoteProject alloc] initWithNode: node] autorelease];
	}
	...
	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			...
			self.issueSecurityScheme = [[RemoteScheme newWithNode: [Soap getNode: node withName: @"issueSecurityScheme"]] object];
			self.key = [Soap getNodeValue: node withName: @"key"];
			self.lead = [Soap getNodeValue: node withName: @"lead"];
			self.notificationScheme = [[RemoteScheme newWithNode: [Soap getNode: node withName: @"notificationScheme"]] object];
			self.permissionScheme = [[RemotePermissionScheme newWithNode: [Soap getNode: node withName: @"permissionScheme"]] object];
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[RemoteProject class]]) {
