/*
	RemoteIssue.h
	The implementation of properties and methods for the RemoteIssue object.
...
@implementation RemoteIssue
	...
	- (id) init
	{
		if(self = [super init])
		{
			self.affectsVersions = nil; // [[ArrayOf_tns1_RemoteVersion alloc] init];
			self.assignee = nil;
			self.attachmentNames = nil; // [[ArrayOf_xsd_string alloc] init];
			self.components = nil; // [[ArrayOf_tns1_RemoteComponent alloc] init];
			self.created = nil;
			self.customFieldValues = nil; // [[ArrayOf_tns1_RemoteCustomFieldValue alloc] init];
			self.description = nil;
			self.duedate = nil;
			self.environment = nil;
			self.fixVersions = nil; // [[ArrayOf_tns1_RemoteVersion alloc] init];
			self.key = nil;
			self.priority = nil;
			self.project = nil;
			self.reporter = nil;
	...
	+ (RemoteIssue*) newWithNode: (CXMLNode*) node
	{
		...
		return (RemoteIssue*)[[[RemoteIssue alloc] initWithNode: node] autorelease];
	}

	- (id) initWithNode: (CXMLNode*) node {
		if(self = [super initWithNode: node])
		{
			self.affectsVersions = [[ArrayOf_tns1_RemoteVersion newWithNode: [Soap getNode: node withName: @"affectsVersions"]] object];
			self.assignee = [Soap getNodeValue: node withName: @"assignee"];
			self.attachmentNames = [[ArrayOf_xsd_string newWithNode: [Soap getNode: node withName: @"attachmentNames"]] object];
			self.components = [[ArrayOf_tns1_RemoteComponent newWithNode: [Soap getNode: node withName: @"components"]] object];
			self.created = [Soap dateFromString: [Soap getNodeValue: node withName: @"created"]];
			self.customFieldValues = [[ArrayOf_tns1_RemoteCustomFieldValue newWithNode: [Soap getNode: node withName: @"customFieldValues"]] object];
			...
			self.fixVersions = [[ArrayOf_tns1_RemoteVersion newWithNode: [Soap getNode: node withName: @"fixVersions"]] object];
	...
	-(BOOL)isEqual:(id)object{
		if(object != nil && [object isKindOfClass:[RemoteIssue class]]) {
