...
static const double IssueViewControllerTextAnimationDuration = 0.33;
@implementation IssueViewCellDescription
...
- (void)setData:(id)dataObject forRow:(NSInteger)aRowIndex inSection:(NSInteger)aSectionIndex
{
	...
	IssueCell *cell =
	(IssueCell *)[self.tableView cellForRowAtIndexPath:indexPath];
...
//
// Convenience method to create a IssueViewCellDescription and insert it at the
// specified location
//
// Parameters:
...
withAnimation:(UITableViewRowAnimation)animation
{
	...
	[tableSection
	 insertObject:
	 [[[IssueViewCellDescription alloc] initWithCellClass:aClass andData:cellData] autorelease]
	 atIndex:aRowIndex];
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)anIndexPath
{
	...
	IssueViewCellDescription *description = [rows objectAtIndex:anIndexPath.row];
	NSString *cellIdentifier = [description.cellClass reuseIdentifier];
	
	IssueCell *cell =
	(IssueCell *)[tableView dequeueReusableCellWithIdentifier:cellIdentifier];
	if (cell == nil)
	{
...
{
	IssueCell *cell = (IssueCell *)[aTableView cellForRowAtIndexPath:anIndexPath];
	if (![cell isKindOfClass:[IssueCell class]])
	{
		return;
	}
...
- (void)keyboardWillHideNotification:(NSNotification *)aNotification
{
	...
	[UIView setAnimationDuration:IssueViewControllerTextAnimationDuration];
...
- (void)keyboardWillShowNotification:(NSNotification *)aNotification
{
	...
	const CGFloat IssueViewControllerTextFieldScrollSpacing = 40;
	
	CGRect textFieldRect =
	[self.tableView convertRect:currentTextField.bounds fromView:currentTextField];
	textFieldRect = CGRectInset(textFieldRect, 0, -IssueViewControllerTextFieldScrollSpacing);
