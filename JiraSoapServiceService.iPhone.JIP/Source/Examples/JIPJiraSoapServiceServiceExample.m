/*
	JIPJiraSoapServiceServiceExample.m
...
@implementation JIPJiraSoapServiceServiceExample

- (void)run {
	// Create the service
	JIPJiraSoapServiceService* service = [JIPJiraSoapServiceService service];
	service.logging = YES;
	...
	// Returns . 
	[service addActorsToProjectRole:self action:@selector(addActorsToProjectRoleHandler:) in0: @"" in1: [[JIPArrayOf_xsd_string alloc] init] in2: [[JIPRemoteProjectRole alloc] init] in3: [[JIPRemoteProject alloc] init] in4: @""];

	// Returns BOOL. 
	[service addAttachmentsToIssue:self action:@selector(addAttachmentsToIssueHandler:) in0: @"" in1: @"" in2: [[JIPArrayOf_xsd_string alloc] init] in3: [[JIPArrayOf_xsd_base64Binary alloc] init]];

	// Returns BOOL. 
	[service addBase64EncodedAttachmentsToIssue:self action:@selector(addBase64EncodedAttachmentsToIssueHandler:) in0: @"" in1: @"" in2: [[JIPArrayOf_xsd_string alloc] init] in3: [[JIPArrayOf_xsd_string alloc] init]];

	// Returns . 
	[service addComment:self action:@selector(addCommentHandler:) in0: @"" in1: @"" in2: [[JIPRemoteComment alloc] init]];

	// Returns . 
	[service addDefaultActorsToProjectRole:self action:@selector(addDefaultActorsToProjectRoleHandler:) in0: @"" in1: [[JIPArrayOf_xsd_string alloc] init] in2: [[JIPRemoteProjectRole alloc] init] in3: @""];

	// Returns JIPRemotePermissionScheme*. 
	[service addPermissionTo:self action:@selector(addPermissionToHandler:) in0: @"" in1: [[JIPRemotePermissionScheme alloc] init] in2: [[JIPRemotePermission alloc] init] in3: [[JIPRemoteEntity alloc] init]];

	// Returns . 
	[service addUserToGroup:self action:@selector(addUserToGroupHandler:) in0: @"" in1: [[JIPRemoteGroup alloc] init] in2: [[JIPRemoteUser alloc] init]];

	// Returns JIPRemoteVersion*. 
	[service addVersion:self action:@selector(addVersionHandler:) in0: @"" in1: @"" in2: [[JIPRemoteVersion alloc] init]];

	// Returns JIPRemoteWorklog*. 
	[service addWorklogAndAutoAdjustRemainingEstimate:self action:@selector(addWorklogAndAutoAdjustRemainingEstimateHandler:) in0: @"" in1: @"" in2: [[JIPRemoteWorklog alloc] init]];

	// Returns JIPRemoteWorklog*. 
	[service addWorklogAndRetainRemainingEstimate:self action:@selector(addWorklogAndRetainRemainingEstimateHandler:) in0: @"" in1: @"" in2: [[JIPRemoteWorklog alloc] init]];

	// Returns JIPRemoteWorklog*. 
	[service addWorklogWithNewRemainingEstimate:self action:@selector(addWorklogWithNewRemainingEstimateHandler:) in0: @"" in1: @"" in2: [[JIPRemoteWorklog alloc] init] in3: @""];

	// Returns . 
	[service archiveVersion:self action:@selector(archiveVersionHandler:) in0: @"" in1: @"" in2: @"" in3: NO];

	// Returns JIPRemoteGroup*. 
	[service createGroup:self action:@selector(createGroupHandler:) in0: @"" in1: @"" in2: [[JIPRemoteUser alloc] init]];

	// Returns JIPRemoteIssue*. 
	[service createIssue:self action:@selector(createIssueHandler:) in0: @"" in1: [[JIPRemoteIssue alloc] init]];

	// Returns JIPRemoteIssue*. 
	[service createIssueWithSecurityLevel:self action:@selector(createIssueWithSecurityLevelHandler:) in0: @"" in1: [[JIPRemoteIssue alloc] init] in2: 0];

	// Returns JIPRemotePermissionScheme*. 
	[service createPermissionScheme:self action:@selector(createPermissionSchemeHandler:) in0: @"" in1: @"" in2: @""];

	// Returns JIPRemoteProject*. 
	[service createProject:self action:@selector(createProjectHandler:) in0: @"" in1: @"" in2: @"" in3: @"" in4: @"" in5: @"" in6: [[JIPRemotePermissionScheme alloc] init] in7: [[JIPRemoteScheme alloc] init] in8: [[JIPRemoteScheme alloc] init]];

	// Returns JIPRemoteProject*. 
	[service createProjectFromObject:self action:@selector(createProjectFromObjectHandler:) in0: @"" in1: [[JIPRemoteProject alloc] init]];

	// Returns JIPRemoteProjectRole*. 
	[service createProjectRole:self action:@selector(createProjectRoleHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init]];
	...
	// Returns JIPRemotePermissionScheme*. 
	[service deletePermissionFrom:self action:@selector(deletePermissionFromHandler:) in0: @"" in1: [[JIPRemotePermissionScheme alloc] init] in2: [[JIPRemotePermission alloc] init] in3: [[JIPRemoteEntity alloc] init]];
	...
	// Returns . 
	[service deleteProjectRole:self action:@selector(deleteProjectRoleHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init] in2: NO];
	...
	[service editComment:self action:@selector(editCommentHandler:) in0: @"" in1: [[JIPRemoteComment alloc] init]];
	...
	[service getAssociatedNotificationSchemes:self action:@selector(getAssociatedNotificationSchemesHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init]];

	// Returns JIPArrayOf_tns1_RemoteScheme*. 
	[service getAssociatedPermissionSchemes:self action:@selector(getAssociatedPermissionSchemesHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init]];
	...
	[service getDefaultRoleActors:self action:@selector(getDefaultRoleActorsHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init]];
	...
	// Returns JIPArrayOf_tns1_RemoteIssue*. 
	[service getIssuesFromTextSearchWithProject:self action:@selector(getIssuesFromTextSearchWithProjectHandler:) in0: @"" in1: [[JIPArrayOf_xsd_string alloc] init] in2: @"" in3: 0];
	...
	[service getProjectRoleActors:self action:@selector(getProjectRoleActorsHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init] in2: [[JIPRemoteProject alloc] init]];
	...
	// Returns BOOL. 
	[service hasPermissionToEditComment:self action:@selector(hasPermissionToEditCommentHandler:) in0: @"" in1: [[JIPRemoteComment alloc] init]];
	...
	// Returns JIPRemoteIssue*. 
	[service progressWorkflowAction:self action:@selector(progressWorkflowActionHandler:) in0: @"" in1: @"" in2: @"" in3: [[JIPArrayOf_tns1_RemoteFieldValue alloc] init]];

	// Returns . 
	[service refreshCustomFields:self action:@selector(refreshCustomFieldsHandler:) in0: @""];

	// Returns . 
	[service releaseVersion:self action:@selector(releaseVersionHandler:) in0: @"" in1: @"" in2: [[JIPRemoteVersion alloc] init]];

	// Returns . 
	[service removeActorsFromProjectRole:self action:@selector(removeActorsFromProjectRoleHandler:) in0: @"" in1: [[JIPArrayOf_xsd_string alloc] init] in2: [[JIPRemoteProjectRole alloc] init] in3: [[JIPRemoteProject alloc] init] in4: @""];

	// Returns . 
	[service removeAllRoleActorsByNameAndType:self action:@selector(removeAllRoleActorsByNameAndTypeHandler:) in0: @"" in1: @"" in2: @""];

	// Returns . 
	[service removeAllRoleActorsByProject:self action:@selector(removeAllRoleActorsByProjectHandler:) in0: @"" in1: [[JIPRemoteProject alloc] init]];

	// Returns . 
	[service removeDefaultActorsFromProjectRole:self action:@selector(removeDefaultActorsFromProjectRoleHandler:) in0: @"" in1: [[JIPArrayOf_xsd_string alloc] init] in2: [[JIPRemoteProjectRole alloc] init] in3: @""];

	// Returns . 
	[service removeUserFromGroup:self action:@selector(removeUserFromGroupHandler:) in0: @"" in1: [[JIPRemoteGroup alloc] init] in2: [[JIPRemoteUser alloc] init]];
	...
	// Returns JIPRemoteGroup*. 
	[service updateGroup:self action:@selector(updateGroupHandler:) in0: @"" in1: [[JIPRemoteGroup alloc] init]];

	// Returns JIPRemoteIssue*. 
	[service updateIssue:self action:@selector(updateIssueHandler:) in0: @"" in1: @"" in2: [[JIPArrayOf_tns1_RemoteFieldValue alloc] init]];

	// Returns JIPRemoteProject*. 
	[service updateProject:self action:@selector(updateProjectHandler:) in0: @"" in1: [[JIPRemoteProject alloc] init]];

	// Returns . 
	[service updateProjectRole:self action:@selector(updateProjectRoleHandler:) in0: @"" in1: [[JIPRemoteProjectRole alloc] init]];

	// Returns . 
	[service updateWorklogAndAutoAdjustRemainingEstimate:self action:@selector(updateWorklogAndAutoAdjustRemainingEstimateHandler:) in0: @"" in1: [[JIPRemoteWorklog alloc] init]];

	// Returns . 
	[service updateWorklogAndRetainRemainingEstimate:self action:@selector(updateWorklogAndRetainRemainingEstimateHandler:) in0: @"" in1: [[JIPRemoteWorklog alloc] init]];

	// Returns . 
	[service updateWorklogWithNewRemainingEstimate:self action:@selector(updateWorklogWithNewRemainingEstimateHandler:) in0: @"" in1: [[JIPRemoteWorklog alloc] init] in2: @""];
}
...
- (void) addPermissionToHandler: (id) value {
	...
	// Do something with the JIPRemotePermissionScheme* result
		JIPRemotePermissionScheme* result = (JIPRemotePermissionScheme*)value;
...
- (void) addVersionHandler: (id) value {
	...
	// Do something with the JIPRemoteVersion* result
		JIPRemoteVersion* result = (JIPRemoteVersion*)value;
...
- (void) addWorklogAndAutoAdjustRemainingEstimateHandler: (id) value {
	...
	// Do something with the JIPRemoteWorklog* result
		JIPRemoteWorklog* result = (JIPRemoteWorklog*)value;
...
- (void) createGroupHandler: (id) value {
	...
	// Do something with the JIPRemoteGroup* result
		JIPRemoteGroup* result = (JIPRemoteGroup*)value;
...
- (void) createIssueHandler: (id) value {
	...
	// Do something with the JIPRemoteIssue* result
		JIPRemoteIssue* result = (JIPRemoteIssue*)value;
...
- (void) createProjectHandler: (id) value {
	...
	// Do something with the JIPRemoteProject* result
		JIPRemoteProject* result = (JIPRemoteProject*)value;
...
- (void) createProjectRoleHandler: (id) value {
	...
	// Do something with the JIPRemoteProjectRole* result
		JIPRemoteProjectRole* result = (JIPRemoteProjectRole*)value;
...
- (void) createUserHandler: (id) value {
	...
	// Do something with the JIPRemoteUser* result
		JIPRemoteUser* result = (JIPRemoteUser*)value;
...
- (void) editCommentHandler: (id) value {
	...
	// Do something with the JIPRemoteComment* result
		JIPRemoteComment* result = (JIPRemoteComment*)value;
...
- (void) getAllPermissionsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemotePermission* result
		JIPArrayOf_tns1_RemotePermission* result = (JIPArrayOf_tns1_RemotePermission*)value;
...
- (void) getAssociatedNotificationSchemesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteScheme* result
		JIPArrayOf_tns1_RemoteScheme* result = (JIPArrayOf_tns1_RemoteScheme*)value;
...
- (void) getAttachmentsFromIssueHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteAttachment* result
		JIPArrayOf_tns1_RemoteAttachment* result = (JIPArrayOf_tns1_RemoteAttachment*)value;
...
- (void) getAvailableActionsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteNamedObject* result
		JIPArrayOf_tns1_RemoteNamedObject* result = (JIPArrayOf_tns1_RemoteNamedObject*)value;
...
- (void) getCommentsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteComment* result
		JIPArrayOf_tns1_RemoteComment* result = (JIPArrayOf_tns1_RemoteComment*)value;
...
- (void) getComponentsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteComponent* result
		JIPArrayOf_tns1_RemoteComponent* result = (JIPArrayOf_tns1_RemoteComponent*)value;
...
- (void) getConfigurationHandler: (id) value {
	...
	// Do something with the JIPRemoteConfiguration* result
		JIPRemoteConfiguration* result = (JIPRemoteConfiguration*)value;
...
- (void) getCustomFieldsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteField* result
		JIPArrayOf_tns1_RemoteField* result = (JIPArrayOf_tns1_RemoteField*)value;
...
- (void) getDefaultRoleActorsHandler: (id) value {
	...
	// Do something with the JIPRemoteRoleActors* result
		JIPRemoteRoleActors* result = (JIPRemoteRoleActors*)value;
...
- (void) getFavouriteFiltersHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteFilter* result
		JIPArrayOf_tns1_RemoteFilter* result = (JIPArrayOf_tns1_RemoteFilter*)value;
...
- (void) getIssuesFromFilterHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteIssue* result
		JIPArrayOf_tns1_RemoteIssue* result = (JIPArrayOf_tns1_RemoteIssue*)value;
...
- (void) getIssueTypesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteIssueType* result
		JIPArrayOf_tns1_RemoteIssueType* result = (JIPArrayOf_tns1_RemoteIssueType*)value;
...
- (void) getPermissionSchemesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemotePermissionScheme* result
		JIPArrayOf_tns1_RemotePermissionScheme* result = (JIPArrayOf_tns1_RemotePermissionScheme*)value;
...
- (void) getPrioritiesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemotePriority* result
		JIPArrayOf_tns1_RemotePriority* result = (JIPArrayOf_tns1_RemotePriority*)value;
...
- (void) getProjectAvatarHandler: (id) value {
	...
	// Do something with the JIPRemoteAvatar* result
		JIPRemoteAvatar* result = (JIPRemoteAvatar*)value;
...
- (void) getProjectAvatarsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteAvatar* result
		JIPArrayOf_tns1_RemoteAvatar* result = (JIPArrayOf_tns1_RemoteAvatar*)value;
...
- (void) getProjectRoleActorsHandler: (id) value {
	...
	// Do something with the JIPRemoteProjectRoleActors* result
		JIPRemoteProjectRoleActors* result = (JIPRemoteProjectRoleActors*)value;
...
- (void) getProjectRolesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteProjectRole* result
		JIPArrayOf_tns1_RemoteProjectRole* result = (JIPArrayOf_tns1_RemoteProjectRole*)value;
...
- (void) getProjectsNoSchemesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteProject* result
		JIPArrayOf_tns1_RemoteProject* result = (JIPArrayOf_tns1_RemoteProject*)value;
...
- (void) getResolutionsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteResolution* result
		JIPArrayOf_tns1_RemoteResolution* result = (JIPArrayOf_tns1_RemoteResolution*)value;
...
- (void) getSecurityLevelHandler: (id) value {
	...
	// Do something with the JIPRemoteSecurityLevel* result
		JIPRemoteSecurityLevel* result = (JIPRemoteSecurityLevel*)value;
...
- (void) getSecurityLevelsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteSecurityLevel* result
		JIPArrayOf_tns1_RemoteSecurityLevel* result = (JIPArrayOf_tns1_RemoteSecurityLevel*)value;
...
- (void) getServerInfoHandler: (id) value {
	...
	// Do something with the JIPRemoteServerInfo* result
		JIPRemoteServerInfo* result = (JIPRemoteServerInfo*)value;
...
- (void) getStatusesHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteStatus* result
		JIPArrayOf_tns1_RemoteStatus* result = (JIPArrayOf_tns1_RemoteStatus*)value;
...
- (void) getVersionsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteVersion* result
		JIPArrayOf_tns1_RemoteVersion* result = (JIPArrayOf_tns1_RemoteVersion*)value;
...
- (void) getWorklogsHandler: (id) value {
	...
	// Do something with the JIPArrayOf_tns1_RemoteWorklog* result
		JIPArrayOf_tns1_RemoteWorklog* result = (JIPArrayOf_tns1_RemoteWorklog*)value;
